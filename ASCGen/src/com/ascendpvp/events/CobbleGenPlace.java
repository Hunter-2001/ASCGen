...
public class CobbleGenPlace implements Listener {

	ASCGenMain plugin;
	public CobbleGenPlace(ASCGenMain plugin) {
		this.plugin = plugin;
	}
	...
	public void onPlace(BlockPlaceEvent e) {
		...
		double price = plugin.getConfig().getDouble("cobble_per_place_price");
		...
		if (!p.getItemInHand().getItemMeta().getDisplayName().equals(cc(plugin.getConfig().getString("cobble_gen_name")))) return;
		if(!(pBalance >= price)) {
